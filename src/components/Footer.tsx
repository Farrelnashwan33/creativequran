...
const Footer = () => {
  return (
    <footer id="footer" className="bg-white pt-20 pb-10 border-t border-secondary">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-6 col-span-1 lg:col-span-1">
            ...
            <div className="flex items-center gap-4">
              <Link href="#" className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center text-foreground/60 hover:bg-primary hover:text-white transition-all">
                <Globe size={20} />
              </Link>
              <Link href="#" className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center text-foreground/60 hover:bg-primary hover:text-white transition-all">
          ...
          {/* Features */}
          <div>
            <h4 className="text-lg font-bold mb-6">Fitur</h4>
            <ul className="flex flex-col gap-4">
